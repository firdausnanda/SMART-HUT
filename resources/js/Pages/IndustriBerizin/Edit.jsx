...
export default function Edit({ auth, data: item, jenis_produksi_list }) {
  const { data, setData, patch, processing, errors } = useForm({
    ...
    phhk_pbhh: item.phhk_pbhh || '',
    phhbk_pbphh: item.phhbk_pbphh || '',
  ...
  const submit = (e) => {
    e.preventDefault();
    patch(route('industri-berizin.update', item.id));
  };
  ...
  return (
    ...
    >
      <Head title="Edit Industri Berizin" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 border-b border-gray-100 bg-gray-50/50">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Perbarui informasi industri berizin di bawah ini.
            </p>
          </div>
