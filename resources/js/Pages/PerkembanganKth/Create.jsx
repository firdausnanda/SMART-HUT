...
export default function Create({ auth }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    post(route('perkembangan-kth.store'));
  };
  ...
  return (
    ...
    >
      <Head title="Input Perkembangan KTH" />
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 border-b border-gray-100 bg-gray-50/50">
            <h3 className="text-xl font-bold text-gray-900">Formulir Input Data KTH</h3>
            <p className="mt-1 text-sm text-gray-500">
              Lengkapi informasi di bawah ini untuk menambahkan data Kelompok Tani Hutan baru.
            </p>
          </div>
            ...
            <form onSubmit={submit} className="space-y-8">
              ...
              <div className="pt-6 border-t border-gray-100 flex items-center justify-end gap-4">
                ...
                <PrimaryButton
                  ...
                  loading={processing}
                >
                  {processing ? 'Menyimpan...' : 'Simpan Data KTH'}
                </PrimaryButton>
              </div>
            </form>
          </div>
