...
export default function Create({ auth, pengelolaWisata }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    post(route('pengunjung-wisata.store'));
  };
  ...
  return (
    ...
    >
      <Head title="Input Pengunjung Wisata" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 border-b border-gray-100 bg-gray-50/50">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Lengkapi informasi di bawah ini untuk menambahkan data pengunjung objek wisata baru.
            </p>
          </div>
