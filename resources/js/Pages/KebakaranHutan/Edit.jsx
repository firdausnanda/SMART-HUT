...
export default function Edit({ auth, data: item, pengelolaWisata }) {
  const { data, setData, patch, processing, errors } = useForm({
    ...
    area_function: item.area_function || '',
    number_of_fires: item.number_of_fires || '',
    fire_area: item.fire_area || '',
  ...
  const submit = (e) => {
    e.preventDefault();
    patch(route('kebakaran-hutan.update', item.id));
  };
  ...
  return (
    ...
    >
      <Head title="Edit Kebakaran Hutan" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 border-b border-gray-100 bg-gray-50/50">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Perbarui informasi laporan kebakaran hutan di bawah ini.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div>
                  ...
                  <Select
                    ...
                    value={villages.find(v => v.value == data.village_id) || (item.village ? { value: item.village_id, label: formatLabel(item.village.name) } : null)}
