...
export default function Create({ auth, sumberDana }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    post(route('rehab-manggrove.store'));
  };
  ...
  return (
    ...
    >
      <Head title="Input Rehabilitasi Manggrove" />

      <div className="max-w-4xl mx-auto">
        <Link
          href={route('rehab-manggrove.index')}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 border-b border-gray-100 bg-gray-50/50">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Lengkapi informasi di bawah ini untuk menambahkan data rehabilitasi manggrove baru.
            </p>
          </div>
