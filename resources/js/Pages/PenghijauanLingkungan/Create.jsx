...
export default function Create({ auth, sumberDana }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    post(route('penghijauan-lingkungan.store'));
  };
  ...
  return (
    ...
    >
      <Head title="Input Penghijauan Lingkungan" />

      <div className="max-w-4xl mx-auto">
        <Link
          href={route('penghijauan-lingkungan.index')}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 border-b border-gray-100 bg-gray-50/50">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Lengkapi informasi di bawah ini untuk menambahkan data penghijauan lingkungan baru.
            </p>
          </div>
