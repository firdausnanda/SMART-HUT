...
class ReboisasiPsController extends Controller
{
  ...
  public function singleWorkflowAction(Request $request, ReboisasiPS $reboisasiPs, SingleWorkflowAction $action)
  {
    ...
    match ($workflowAction) {
      WorkflowAction::SUBMIT => $this->authorize('reboisasi-ps.edit'),
      WorkflowAction::APPROVE, WorkflowAction::REJECT => $this->authorize('reboisasi-ps.approve'),
      WorkflowAction::DELETE => $this->authorize('reboisasi-ps.delete'),
    };
